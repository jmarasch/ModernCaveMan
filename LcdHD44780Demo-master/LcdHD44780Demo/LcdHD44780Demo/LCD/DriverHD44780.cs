...
namespace LcdHD44780
{
    internal class DriverHD44780
    {
        ...
        /* Uncomment for Raspberry Pi 2 SPI Bus0*/
        ...
        /* Uncomment for Raspberry Pi 2 SPI Bus1 */
        private const string SPI_CONTROLLER_NAME = "SPI1";    /* For Raspberry Pi 2, use SPI0                             */
        private const Int32 SPI_CHIP_SELECT_LINE = 0;         /* Line 0 maps to physical pin number 12? on the Rpi2        */
        //private const Int32 DATA_COMMAND_PIN = 22;            /* We use GPIO 22 since it's conveniently near the SPI pins */
        //private const Int32 RESET_PIN = 23;                   /* We use GPIO 23 since it's conveniently near the SPI pins */
